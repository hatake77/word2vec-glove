...
def parse_args():
    ...
    g_cooccur.add_argument('--cooccur-path',
                           help=('Path to cooccurrence matrix file. If '
                                 ...
                                 'this file.'))
    g_cooccur.add_argument('-w', '--window-size', type=int, default=8,
...
def build_cooccur(vocab, corpus, window_size=10, min_count=None):
    ...
    with open("id2word.pkl", 'wb') as id2word_f:
        pickle.dump(id2word, id2word_f, protocol=2)
...
def main(arguments):
    ...
    if arguments.save_often:
        iter_callback = partial(save_model, path="model.pkl")
    else:
        iter_callback = None
